...
import { TrendingUp, Search, ArrowRight, Star, Clock, User } from 'lucide-react';
...
const DigitalMarketing = () => {
  ...
  useEffect(() => {
    const fetchCaseStudies = async () => {
      setLoading(true);
      try {
        const res = await fetch('https://blog-backend-g3la.onrender.com/api/case-studies?category=digital-marketing&page=1&limit=12');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <TrendingUp size={48} className="mr-3" />
              <h1 className="text-4xl font-bold">Digital Marketing</h1>
            </div>
            <p className="text-xl text-orange-100 max-w-3xl mx-auto mb-8">
              Explore how companies are leveraging digital channels to build brands, engage audiences, 
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search digital marketing case studies..."
                  value={searchQuery}
            ...
            <article key={study._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-orange-600 font-medium">Digital Marketing</span>
                  <span className="text-sm text-gray-500">{formatDate(study.createdAt)}</span>
                </div>

                <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-orange-600 transition-colors duration-200">
                  {study.title}
                </h3>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-orange-100 text-orange-700 font-semibold flex items-center justify-center">
                ...
                <Link
                  ...
                  className="w-full bg-orange-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-orange-700 transition-colors duration-200 flex items-center justify-center group"
                >
                  View Case Study
