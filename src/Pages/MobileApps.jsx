...
const MobileApps = () => {
  ...
  useEffect(() => {
    const fetchCaseStudies = async () => {
      setLoading(true);
      try {
        const res = await fetch('https://blog-backend-g3la.onrender.com/api/case-studies?category=mobile-apps&page=1&limit=12');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <Smartphone size={48} className="mr-3" />
              <h1 className="text-4xl font-bold">Mobile Applications</h1>
            </div>
            <p className="text-xl text-green-100 max-w-3xl mx-auto mb-8">
              Explore how mobile apps are reshaping industries and user experiences. 
              Learn from successful mobile-first companies and their strategies.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search mobile app case studies..."
                  value={searchQuery}
